...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="git-multiagent-host-auth-proxy")
...
def main(argv: list[str] | None = None) -> int:
    ...
    proxy_token = os.environ.get("GIT_MULTIAGENT_HOST_AUTH_TOKEN")
    if not proxy_token:
        print("error: GIT_MULTIAGENT_HOST_AUTH_TOKEN is required", file=sys.stderr)
        return 2
